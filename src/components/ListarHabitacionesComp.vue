<template>
  <h1 class="flex items-center text-5xl font-extrabold dark:text-white m-1 p-1 ">Hotel<span class="bg-blue-100 text-blue-800 text-2xl font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-2">EMPERADOR</span></h1>
  <div class="mt-9 p-10">
